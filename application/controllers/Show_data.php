...
class Show_data extends CI_Controller {
	...
	{
		$data['row'] = $this->Get_data_model->Get_completed();
		$this->load->view('theme/head');
	...
	{
		$data['row'] = $this->Get_data_model->Get_reject();
		$this->load->view('theme/head');
		...
		<div class="col-md-12 col-xs-12" >
			<div class="table-responsive">
				<table  width="100%" class="table table-bordered  table-striped">
					<tr class="info">
						<th width="10%" rowspan="2" style="text-align: center;"><b>Unit</b></th>
						<th width="5%"  rowspan="2" style="text-align: center;"><b>Qty</b></th>
						<th width="5%" rowspan="2" style="text-align: center;"><b>No.</b></th>
						<th width="40%" rowspan="2" style="text-align: center;"><b>Description</b></th>
						<th width="10%" rowspan="2" style="text-align: center;"><b>Delivery Date</b></th>
						<th width="20%" colspan="2" style="text-align: center;"><b>Last Purchase</b></th>
						<th width="5%" rowspan="2" style="text-align: center;"><b>Unit Price</b></th>
						<th width="5%" rowspan="2" style="text-align: center;"><b>Total</b></th>
					</tr>
					<tr class="info">
						<th width="10%" style="text-align: center;"><b>Date</b></th>
						<th width="10%" style="text-align: center;"><b>Unit Price</b></th>
					</tr>';
					...
					echo '<tr>
						...
						<td style="text-align: center;">';$warecode = $row['prdcode']; $iremark = $this->Get_data_model->iremark($warecode); $ciremark = $row['iremark'];  echo $iremark[0]['stname1']; if ($ciremark >0) {
								echo '[* '.$ciremark.' *]';
						} echo'</td>
