...
class Add_Pr extends CI_Controller {
	...
	public function updatepr()
	{
		...
		$this->Addpr_model->updatepr($prno,$div,$remark,$warecode,$dc,$dc_a,$vat,$vendor,$vendorname,$depname,$depcode);
	}
	...
	public function doupload()
	{
		...
		if (isset($_FILES['file']['name'])) {
			...
			// PRA 253
			$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'\PRA\upload\file_upload';
