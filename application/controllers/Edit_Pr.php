...
class Edit_Pr extends CI_Controller {
	...
	public function editupper()
	{
		...
		$this->Editpr_model->editupper($prno,$div,$remark,$warecode,$dc,$dc_a,$vat,$vendor,$vendorname,$depname,$depcode,$typuser,$username,$date,$gmremark,$efcremark);
	}
	...
	public function editupper2()
	{
		...
		$typuser = $this->session->type;
		$username = $this->session->username;
		$this->Editpr_model->editupper2($prno,$div,$remark,$warecode,$dc,$dc_a,$vat,$vendor,$vendorname,$depname,$depcode,$typuser,$username,$date,$gmremark,$efcremark);
	}	
