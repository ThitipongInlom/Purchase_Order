...
public function url()
{
	...
	$arry = array(
		...
		'restatusapp' => $server_root.'index.php/Show_data/resetstatusapp',
		'approve' => $server_root.'index.php/Show_data/approveY',
		'approvex' => $server_root.'index.php/Show_data/approveX',
		'approvex_sd' => $server_root.'index.php/Show_data/approveX_sd',
		'hold_pr' => $server_root.'index.php/Show_data/hold_pr',
		'approvexold' => $server_root.'index.php/Show_data/approveXold',
		...
		'Loadimgpr' => $server_root.'index.php/Edit_Pr/getimgdataedit',
		'UploadImg' => $server_root.'index.php/Edit_Pr/UploadImg',
		'Delete_PR' => $server_root.'index.php/Show_data/Delete_PR',
		'DeleteUploadImg' => $server_root.'index.php/Edit_Pr/Dalete_loadimg',	
	);
