...
class Editpr_model extends CI_Model {
	...
	public function editupper($prno,$div,$remark,$warecode,$dc,$dc_a,$vat,$vendor,$vendorname,$depname,$depcode,$typuser,$username,$date,$gmremark,$efcremark)
	{
	...
	public function editupper2($prno,$div,$remark,$warecode,$dc,$dc_a,$vat,$vendor,$vendorname,$depname,$depcode,$typuser,$username,$date,$gmremark,$efcremark)
	{
		if ($typuser=='user' OR $typuser=='admin') {
			$PR = array(
				'div' => $div,
