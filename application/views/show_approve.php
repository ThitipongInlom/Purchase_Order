...
<html>
  ...
  <!-- Modal -->
    ...
    if (username == 'Somkhit' || username == 'Nuntaporn2') {
      ...
      "processing": true,
      "ajax": {
          "url": "<?php echo site_url('index.php/Get_table_data/Show_Table_show_approve'); ?>",
          "type": "POST",
      },
      "columnDefs": [
      { "data": 'action', "className": 'text-center' ,"width": "10%", "targets": 0 },
      { "data": 'prno', "width": "8%", "targets": 1 ,"type": 'signed-num'},
      { "data": 'vendor', "width": "17%", "targets": 2 },
      { "data": 'prdate', "width": "11%", "type":"date-eu", "targets": 3 },
      ...
      "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
        if (aData.hold_pr != "") {
          $('td', nRow).css('background-color', '#ffcf00');
          console.log(nRow);
        }
      }
      });    
      ...
      "columnDefs": [
      { "data": 'prno', "width": "8%", "targets": 0 ,"type": 'signed-num'},
      { "data": 'vendor', "width": "17%", "targets": 1 },
      { "data": 'prdate', "width": "11%", "type":"date-eu", "targets": 2 },
      { "data": 'refno', "width": "5%", "targets": 3 },
      { "data": 'warecode', "width": "20%", "targets": 4 },
      { "data": 'comment', "width": "16%", "targets": 5 },
      { "data": 'HdApprove', "width": "1%", "targets": 6 ,"orderData": [ 6, 11 ], "type":"date-eu"},
      { "data": 'PRApprove', "width": "1%", "targets": 7 ,"orderData": [ 7, 12 ], "type":"date-eu"},
      { "data": 'GMApprove', "width": "1%", "targets": 8 ,"orderData": [ 8, 13 ], "type":"date-eu"},
      { "data": 'EFCApprove', "width": "1%", "targets": 9 },
      { "data": 'action', "className": 'text-center' ,"width": "10%", "targets": 10 },
      { "data": 'HdApprove', "width": "10%", "targets": 11 ,"visible": false, "searchable": false, "type":"date-eu"},
      { "data": 'PRApprove', "width": "10%", "targets": 12 ,"visible": false, "searchable": false, "type":"date-eu"},
      { "data": 'GMApprove', "width": "10%", "targets": 13 ,"visible": false, "searchable": false, "type":"date-eu"},
      { "orderable": "false"}
      ],
      "language": {
      "lengthMenu":"แสดง _MENU_ แถว",
