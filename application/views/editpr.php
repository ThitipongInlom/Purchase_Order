        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            <div class="box box-success">
                    ...
                    <div class="table-responsive">
                      <table cellspacing="0" width="100%" class="table table-bordered table-hover responsive">
                        ...
                        <tr>
                          ...
                          <td colspan="6"><textarea class="form-control input-sm" rows="2" id="remark"><?php echo $getdata[0]['remark']; ?></textarea></td>
                          <td>
                            <div valign="middle">
                              <div class="custom-control custom-checkbox" style="margin-top: 15px;">
                                <input type="checkbox" class="custom-control-input" id="express" <?php if ($getdata[0]['express'] == 'true') { echo 'checked';} ?>>
                        ...
                        <tr>
                          <td colspan="2" align="center"><b>รูปภาพแนบ PR</b></td>
                          <td colspan="6"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addimgmodel"><?php echo $this->lang->line('addimagemodal'); ?></button> | <span id="divimgshow"></span></td>
                        </tr>                        
                      </form>
                      </table>
                  	  </div>
                            ...
                            <table cellspacing="0" width="100%" class="table table-bordered table-condensed responsive">
                              <tr class="trinfo">
                                ...
                                <tr class="trinfo">
                                  ...
                                  <td colspan="2"><input type="text" id="itemprqty" class="form-control input-sm" onchange="checkNumberprqty();"></td>
                                  <td width="10%" align="center"><h5><?php echo $this->lang->line('unitprice'); ?></h5></td>
                                  <td width="5%"><input type="text" class="form-control input-sm" id="itemprprice" onchange="checkNumberunitprice();"></td>
              ...
              if ($type=='accounting' OR $type=='accounting0' OR $type=='hod' OR $type=='approval') {
                echo ' <button class="btn btn-primary" onclick="window.history.back();">ย้อนกลับ</button>';
              }
              ?>
              </div>
            </div>
...
<div id="addimgmodel" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close pull-right" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo $this->lang->line('addimagemodal'); ?></h4>
      </div>
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-4">    
          <div class="form-group">
            <label for="uploadimg_1">รูปภาพที่</label>
            <input type="file" class="form-control-file" id="uploadimg_1" name="userfile">
          </div>
          </div>         
        </div>
      </div>
      <div class="modal-footer">
        <div align="center">
          <button type="button" class="btn btn-primary" onclick="UploadImg();"><?php echo $this->lang->line('uploadimage'); ?></button>
          <button type="button" class="btn btn-danger" id="closeadimagemodel" data-dismiss="modal"><?php echo $this->lang->line('close'); ?></button>
        </div>
      </div>
    </div>
  </div>
