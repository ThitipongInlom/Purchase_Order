...
<html>
  ...
  <!-- Modal -->
    ...
    "processing": true,
    "ajax": {
        "url": "<?php echo site_url('index.php/Get_table_data/Show_Table_show_accounting'); ?>",
        "type": "POST",
        "data": function (d) {
          d.typeselect = $("#Setvaluefordata").val();
        }
    },
    "columnDefs": [
    { "data": 'prno', "width": "10%", "targets": 0},
    { "data": 'vendor', "width": "20%", "targets": 1 },
    { "data": 'prdate', "width": "9%", "type":"date-eu", "targets": 2 },
    { "data": 'refno', "width": "8%", "targets": 3 },
    { "data": 'warecode', "width": "20%", "targets": 4 },
    { "data": 'comment', "width": "10%", "targets": 5 },
    ...
    { "data": 'completed', "width": "1%", "targets": 10 },
    { "data": 'action', "className": 'text-center', "width": "10%", "targets": 11 },
    { "orderable": "false"}
    ],
    "language": {
