...
<html>
  ...
  <!-- Modal -->
    ...
    "processing": true,
    "ajax": {
        "url": "<?php echo site_url('index.php/Get_table_data/Show_Table_show_fax'); ?>",
        "type": "POST",
    },
    "columnDefs": [
    { "data": 'checkbox', "width": "5%", "targets": 0 ,"className": 'text-center'},
    { "data": 'prno', "width": "10%", "targets": 1 },
    { "data": 'vendor', "width": "20%", "targets": 2 },
    { "data": 'prdate', "width": "9%", "type":"date-eu", "targets": 3 },
    { "data": 'refno', "width": "8%", "targets": 4 },
    { "data": 'warecode', "width": "20%", "targets": 5 },
    { "data": 'completed', "width": "1%", "targets": 6 },
    { "data": 'chkre', "width": "1%", "targets": 7 },
    { "data": 'fax',"width": "10%", "targets": 8 ,"className": 'text-center'},
    { "data": 'action',"width": "5%", "targets": 9 ,"className": 'text-center'},
    { "orderable": "false"}
    ],
    "language": {
