...
<html>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('index.php/Show_data/show_reject'); ?>"><i class="fa fa-times"></i> <?php echo $this->lang->line('reject'); ?></a></li>
      </ol>
    </section>
    <!-- Main content -->
  ...
  <!-- Modal -->
    ...
    "processing": true,
    "ajax": {
        "url": "<?php echo site_url('index.php/Get_table_data/Show_Table_show_reject'); ?>",
        "type": "POST",
    },
    "columnDefs": [
    { "data": 'prno', "width": "10%", "targets": 0 , "className": 'text-center'},
    { "data": 'vendor', "width": "30%", "targets": 1 },
    { "data": 'prdate', "width": "10%", "type":"date-eu", "targets": 2 },
    { "data": 'refno', "width": "8%", "targets": 3 },
    { "data": 'warecode', "width": "20%", "targets": 4 },
    { "data": 'HdApprove', "width": "1%", "targets": 5 },
    { "data": 'PRApprove', "width": "1%", "targets": 6 },
    { "data": 'GMApprove', "width": "1%", "targets": 7 },
    { "data": 'EFCApprove', "width": "1%", "targets": 8 },
    { "data": 'action', "width": "10%", "targets": 9 , "className": 'text-center'},
    { "orderable": "false"}
    ],
    "language": {
