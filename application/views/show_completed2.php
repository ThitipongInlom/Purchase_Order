...
<html>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <?php echo $this->lang->line('completed2'); ?>
      </h1>
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('index.php/Show_data/show_completed'); ?>"><i class="fa fa-check-circle-o"></i> <?php echo $this->lang->line('completed2'); ?></a></li>
      </ol>
    </section>
    <!-- Main content -->
