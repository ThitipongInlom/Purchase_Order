...
<html>
  ...
  <body class="hold-transition login-page" style="background-image: url('<?php echo base_url().'assets/icon/background.jpg'; ?>'">
    <div class="row">
      <div class="col-md-12">
        <div class="pull-right">
          <select id='langselect'>
            <option value='english' data-image="<?php echo base_url().'assets/icon/en.png'; ?>" <?php if ($this->session->site_lang == 'english') {
            echo 'selected'; } ?>>English</option>
            <option value='thai' data-image="<?php echo base_url().'assets/icon/th.png'; ?>"  <?php if ($this->session->site_lang == 'thai') {
      ...
      <div class="login-box-body">
        ...
        <form name="formlogin" id="formlogin">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="<?php echo $this->lang->line('username'); ?>" id="username">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="<?php echo $this->lang->line('password'); ?>" id="password">
