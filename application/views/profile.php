            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <label for="username" class="control-label"><?php echo $this->lang->line('username'); ?></label>
                    <input type="text" class="form-control" id="username" placeholder="<?php echo $this->lang->line('username'); ?>" value="<?php echo $result[0]->username; ?>">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                  <label for="fname" class="control-label"><?php echo $this->lang->line('fname'); ?></label>
                    <input type="text" class="form-control" id="fname" placeholder="<?php echo $this->lang->line('fname'); ?>" value="<?php echo $result[0]->fname; ?>">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                  <label for="lname" class="control-label"><?php echo $this->lang->line('lname'); ?></label>
                    <input type="text" class="form-control" id="lname" placeholder="<?php echo $this->lang->line('lname'); ?>" value="<?php echo $result[0]->lname; ?>" >
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="email" class="control-label"><?php echo $this->lang->line('email'); ?></label>
                    <input type="text" class="form-control" id="email" placeholder="<?php echo $this->lang->line('email'); ?>" value="<?php echo $result[0]->email; ?>">
                </div>
              </div>
              <div class="col-md-3">
              <br><div align="center">
